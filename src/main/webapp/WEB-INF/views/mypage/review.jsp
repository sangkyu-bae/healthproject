	...
	<div class="mypage_filter_wrap mypage_float_box">
		...
		<div class="mypage_fiter_lst_box">
			<ul class="mypage_fiter_ul">
				...
				<li class="mypage_fiter_list" style="font-weight: bold;"><a href="${path}/mypage/write_review">구매후기</a></li>
			...
			<div class="mypage_section_head sksk">
				...
				<div class="tab-group">
					<div class="tab-btn" style="padding: 3px; ">
						<a href="${path }/mypage/write_review" >후기 작성</a> 
					</div>
					<div class="tab-btn bs">
						<a href="#" style="color:black;">후기 내역</a>
					</div>
				</div>
			</div>
