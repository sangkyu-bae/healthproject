...
<link href="${path}/resources/css/orderlistopt.css" rel="stylesheet"
	type="text/css">
...
-->
<form:form modelAttribute="comment" method="post"  enctype="multipart/form-data" action="${path }/mypage/review_add" id="review_frm">
	<form:input type="hidden" path="productId" />
	<form:input type="hidden" path="reservationInfoId" />
	<input type="hidden" id="score" name="score">
	<input type="hidden" id="comment" name="comment">
	...
	<c:choose>
		<c:when test="${type=='image' }">
			<div class="qna_add_form" style="height: 850px;">
				<div class="review_wrap">
					<div class="qna_categor category_title">사진후기등록</div>
				</div>
				<div class="qna_box_wrap" style="height: 45%;">
		</c:when>
		<c:otherwise>

			<div class="qna_add_form" style="height: 650px;">
				<div class="review_wrap">
					<div class="qna_categor category_title">일반후기등록</div>
				</div>
	...
	<div class="category_title qna_categor">내용</div>
	<div class="qna_categor">
		<textarea name="name" id="review_text" rows="10" cols="68"
			placeholder="내용 입력(5자이상)"></textarea>
	</div>
	</div>
	<div class="">
...
<div class="qna_box_container">
		...
		<div class="question_section_box">
			<ul class="question_section_ul">
				<li class="question_section_list">
					<p>- 상품후기 상품의 후기를 등록하는 게시판입니다.</p>
				</li>
				<li class="question_section_list actent">
					<p>- 욕설, 비방, 거래 글, 분쟁 유발, 명예훼손, 허위사실 유포, 타 쇼핑몰 언급,광고성 등의 부적절한
						게시글은 금지합니다. 더불어 상품 문의 시 비밀글만 작성되도록 제한됩니다.</p>
				</li>
				<li class="question_section_list">
					<p>- 주문번호, 연락처, 계좌번호 등의 개인 정보 관련 내용은 공개되지 않도록 비밀글로 문의해 주시기
						바랍니다. 공개된 글은 비밀글로 전환될 수 있으며, 개인 정보 노출로 인한 피해는 MADAGASCAR가 책임지지
						않습니다.</p>
				</li>
			</ul>
		</div>
	...
	<div class="question_btn_wrap">
		...
		<button type="button" onclick="checkFrm()" class="question_add"
			name="button">등록하기</button>
	</div>
</div>
